...
export default function SellerPopupManagementPage() {
  const { data: popups, loading } = usePopups();
  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <button className="inline-flex items-center gap-2 rounded-full bg-[#eb0000] text-white px-4 py-2 text-sm font-semibold hover:bg-[#d10000] transition">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        {myPopups.map(popup => (
          <article key={popup.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
