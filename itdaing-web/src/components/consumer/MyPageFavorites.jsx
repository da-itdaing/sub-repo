...
export function MyPageFavorites({ onPopupClick, favoriteIds }){
	...
	const favorites = filtered.map(p => ({
		...
		views: p.viewCount,
		image: getImageUrl(p.thumbnail, "https://images.unsplash.com/photo-1555099962-4199c345e5dd?w=800&h=600&fit=crop")
	}));
	return (
