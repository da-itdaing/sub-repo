...
public class PopupCommandService {
    ...
    public Long createPopup(Long sellerId, PopupCreateRequest request) {
        ...
        persistImages(popup, request.thumbnailImageUrl(), request.imageUrls());
    ...
    private void persistImages(Popup popup, String thumbnailImageUrl, List<String> imageUrls) {
