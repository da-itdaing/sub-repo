...
const HeroCarousel = ({ items = [], isLoading = false, onSelect }) => {
  ...
  // 모바일: 2:3 비율 유지 (160x240), 데스크톱: 2:3 비율 유지 (280x420)
  const centerCardWidth = isMobile ? 160 : 280;
  const centerCardHeight = isMobile ? 240 : 420;
  const containerHeight = isMobile ? 280 : 460;
