...
import { Search, ChevronLeft, ChevronRight, CheckCircle2, Clock, XCircle } from 'lucide-react';
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] gap-6">
      ...
      <div className="flex-[1.2] flex flex-col gap-4 min-w-[340px]">
        ...
        <section className="flex-1 rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
          {selectedRequest ? (
