...
const MARKET_TIPS = {
  consumer: [
    { emoji: '🛍️', text: '"수공예품 파는 곳 있어?" 이렇게 물어봐도 돼요' },
    { emoji: '📍', text: '"동구 쪽에 갈만한 곳 있어?" 도 가능해요' },
    { emoji: '🐕', text: '"강아지 데려갈 수 있는 곳 추천해줘!" 도 찾아드려요' },
    { emoji: '🎨', text: '"대인시장 쪽에도 플리마켓 있어?" 도 돼요' },
    { emoji: '❄️', text: '"이번 주말에 열리는 플리마켓 뭐 있어?" 도 가능해요' },
    { emoji: '👨‍👩‍👧', text: '"가족이랑 가기 좋은 데 있어?" 도 알려드려요' },
    { emoji: '🍜', text: '"먹을거 많은 마켓 있어?" 도 찾아드려요' },
    { emoji: '✨', text: '"충장로에서 플리마켓 언제 열려?" 도 물어보세요' },
  ],
  seller: [
    { emoji: '📊', text: '"처음인데 어디서 시작하면 좋을까?" 라고 물어보세요' },
    { emoji: '👥', text: '"사람 많은 존 추천해줘" 도 가능해요' },
    { emoji: '📝', text: '"입점하려면 어떻게 해?" 안내해드려요' },
    { emoji: '🎯', text: '"잘 팔려면 어떻게 해야 돼?" 팁도 알려드려요' },
    { emoji: '📍', text: '"동구쪽에 존 있어?" 찾아드려요' },
    { emoji: '🏪', text: '"주말에 열리는 곳 어디야?" 도 추천해요' },
  ],
};
