...
const MARKET_TIPS = {
  consumer: [
    { emoji: '🛍️', text: '"주말에 갈만한 데 있어?" 이렇게 물어봐도 돼요' },
    { emoji: '📍', text: '"충장로 근처" 처럼 지역 말해주면 더 좋아요' },
    { emoji: '🌙', text: '"야시장 가고 싶어" 라고 말해보세요' },
    { emoji: '🎨', text: '"예술시장" "대인시장" 도 찾아드려요' },
    { emoji: '❄️', text: '"이번달 마켓 뭐 있어?" 도 가능해요' },
    { emoji: '👨‍👩‍👧', text: '"애들이랑 가기 좋은 데" 도 추천해요' },
    { emoji: '🍜', text: '"먹을거 있는 마켓" 도 알려드려요' },
