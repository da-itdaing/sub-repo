...
class AuthControllerSignupTest {
    ...
    void sellerSignup_success_201() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/signup/seller")
            ...
            .andExpect(jsonPath("$.data.profile.profileImage.url").value("https://cdn.example.com/profiles/popup_seller.png"))
    ...
    @Test
    @DisplayName("판매자 회원가입 성공 - 선택 필드(snsUrl, profileImage, introduction) 없이도 성공")
