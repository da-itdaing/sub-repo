...
class SellerPopupControllerTest {
    ...
    void getMyPopups_success() throws Exception {
        PopupSummaryResponse popup = new PopupSummaryResponse(
            ...
            List.of(3L),
            List.of("트렌디"),
            ImagePayload.builder().url("https://example.com/thumb.jpg").key("uploads/thumb.jpg").build(),
            List.of(ImagePayload.builder().url("https://example.com/img1.jpg").key("uploads/img1.jpg").build()),
