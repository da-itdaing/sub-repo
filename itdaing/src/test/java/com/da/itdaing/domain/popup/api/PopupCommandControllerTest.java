...
class PopupCommandControllerTest {
    ...
    void createPopup_success() throws Exception {
        PopupCreateRequest request = new PopupCreateRequest(
            ...
            ImagePayload.builder()
                .url("https://s3.example.com/thumbnail.jpg")
                .key("uploads/thumb.jpg")
                .build(),
            List.of(ImagePayload.builder()
                .url("https://s3.example.com/gallery-1.jpg")
    ...
    void updatePopup_success() throws Exception {
        PopupCreateRequest request = new PopupCreateRequest(
            ...
            List.of(8L),
            List.of(9L),
            ImagePayload.builder().url("https://s3.example.com/new-thumb.jpg").key("uploads/new-thumb.jpg").build(),
            List.of(ImagePayload.builder().url("https://s3.example.com/new-1.jpg").key("uploads/new-1.jpg").build())
        );
